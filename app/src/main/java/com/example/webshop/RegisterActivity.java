...
public class RegisterActivity extends AppCompatActivity {
    ...
    public void register(View view) {
        ...
        Profile profile = new Profile(userName,email,password,phoneNumber);
        mAuth.createUserWithEmailAndPassword(profile.getEmail(), profile.getPassword()).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            @Override
